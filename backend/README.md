...
## Project Structure
    ...
    ├── birthday_calculator_38428  # Django project configurations
...
1. Clone this repo and `cd birthday_calculator_38428`
...
2. Clone this repo and `cd birthday_calculator_38428`
